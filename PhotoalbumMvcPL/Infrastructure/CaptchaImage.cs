...
namespace PhotoalbumMvcPL.Infrastructure
{
    public class CaptchaImage : IDisposable
    {
        ...
        private void GenerateImage()
        {
            ...
            HatchBrush hatchBrush = new HatchBrush(HatchStyle.HorizontalBrick, Color.IndianRed, Color.Maroon);
          //  HatchBrush hatchBrush = new HatchBrush(HatchStyle.SmallConfetti, Color.LightGray, Color.White);//Тут меняется 1.фактура заполнения фона,2. рисунка цвет фона3. цвет заполнения фона
            ...
            float v = 3F;//4F степень искажения (2F, 3F, 4F).
            PointF[] points =
            {
            ...
            // Draw the text.
            hatchBrush = new HatchBrush(HatchStyle.LargeConfetti, Color.LightGray, Color.DarkOrange);//Фактура цвет самих цифр
            ...
            for (int i = 0; i < (int)(rect.Width * rect.Height / 30F); i++)
            {
                ...
                int w = random.Next(m / 20);//чем меньше цифра, тем больше шума по горизонтали
                int h = random.Next(m / 50);//чем меньше цифра, тем больше шума по вертикали, уменьшение обоих цифр забьет все поле 
